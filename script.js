...
let incPrice = 0.5; 				//Augmentation du prix par 0.5

priceCandy.html(priceCandyCane);	//Affiche dans le span le prix d'origine des éléments
priceBall.html(priceXmasBall);
priceCadeau.html(priceCadeaux);

//Ensemble des Upgrades1
let upgrade1 = $(".up1") 			//Bouton Améloriation 1 
let priceUpgrade1 = $("#price1")	//Va chercher le texte du prix
let price1 = 40; 					//Mettre le prix à 40 chocolats
priceUpgrade1.html(price1); 		//Affiche dans le span le prix d'origine de l'amélioration 1 
let nombreUpgrade1 = 0				//Déclarer le compteur d'Amélioration 1
...
//Ensemble des Upgrades2
let upgrade2 = $(".up2") 			//Bouton Améloriation 2
let nombreUpgrade2 = 1				//Déclarer le compteur d'Amélioration 2
let priceUpgrade2 = $("#price2")	//Va chercher le texte du prix
let price2 = 100					//Mettre le prix à 100 chocolats
priceUpgrade2.html(price2);			//Affiche dans le span le prix d'origine de l'amélioration 2
...
//Amélioration 1 - Augmente le nombre de clicks à chaque Amélioration
upgrade1.on('click', function() {
	...
	button.on('click',function() {
		...
		//Affichage du nombre d'amélioration en fonction du nombre d'upgrade obtenu
	if(nombreUpgrade1 ==1){
...
//Améloriation 2 - Nombre de clicks "par secondes"
	//Il n'y aura que 5 upgrade qui s'afficheront car sinon ca va surcharger le bouton d'un point de vue esthétique
upgrade2.on('click', function() {
	if(click >= price2)
	{
		//Fonction qui augmente le prix 
		click -= price2;
		counter.html(click + " Chocolats");
		nombreUpgrade2 ++;
		...
		//Auto-Clicker (click par seconde)
...
//Apparation des images du magasin 
